...
import './Form/Form.scss';
 const Submission = (props) => {
    ...
    return (
        <div>
            <div className={`w-50 m-auto shadow p-3 mb-5 bg-white rounded ${window.matchMedia("(max-width: 580px)").matches?'mobileSubmission':null}`}>
            ...
            <div className="base64-image">
                <strong>Image: </strong>
                <p className="base64-text">{props.data.image}</p>
            </div>
